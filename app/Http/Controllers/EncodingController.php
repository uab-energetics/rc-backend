...
class EncodingController extends Controller {
    ...
    protected function responseValidator($data) {
        return Validator::make($data, [
            ...
            RESPONSE_NUMBER => 'numeric|required_if:type,'.RESPONSE_NUMBER,
            RESPONSE_BOOL => 'boolean|required_if:type,'.RESPONSE_BOOL,
            RESPONSE_RANGE.'_min' => 'numeric|required_if:type,'.RESPONSE_RANGE,
            RESPONSE_RANGE.'_max' => 'numeric|required_if:type,'.RESPONSE_RANGE,
